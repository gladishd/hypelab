...
for (id in uniqueVODs) {
  ...
  total <- paste(total, text, collapse = ' ')
}
...
names(data_char_mobydick) <- "twitch vod"
data_char_mobydick[1] = total
vod_corp <- 
...
all_patterns_df <- vod_dfm %>% 
    dfm_keep(pattern = c("kekw", "lul", "pogchamp", "teep", "teep50", "chris")) %>% 
    convert(to = "data.frame")
    
all_patterns_df$vodid <- uniqueVODs

```

```{r}
ggplot(data = all_patterns_df, aes(x = vodid, y = kekw)) + 
  geom_bar(stat = "identity") +
  labs(x = "VOD", 
       y = "Frequency",
       title = paste('Occurrence of kekw')) + 
  theme(
...
ggsave("occurrenceKekwHighlight.png")
ggplot(data = all_patterns_df, aes(x = vodid, y = lul)) + 
  geom_bar(stat = "identity") +
  labs(x = "VOD", 
       y = "Frequency",
       title = paste('Occurrence of lul')) + 
  theme(
    panel.background = element_rect(fill = "#fffaff",
                              colour = "lightblue",
                              size = 0.1, linetype = "solid"),
  ...
  geom_text(aes(label = paste('#', vodid, sep='')))
ggsave("occurrenceLulHighlight.png")
ggplot(data = all_patterns_df, aes(x = vodid, y = pogchamp)) + 
  geom_bar(stat = "identity") +
  labs(x = "VOD", 
       y = "Frequency",
       title = paste('Occurrence of pogchamp')) + 
  theme(
    panel.background = element_rect(fill = "#fffaff",
                              colour = "lightblue",
                              size = 0.1, linetype = "solid"),
  ...
  geom_text(aes(label = paste('#', vodid, sep='')))
ggsave("occurrencePogchampHighlight.png")
ggplot(data = all_patterns_df, aes(x = vodid, y = teep)) + 
  geom_bar(stat = "identity") +
  labs(x = "VOD", 
       y = "Frequency",
       title = paste('Occurrence of teepHighlight')) + 
  theme(
    panel.background = element_rect(fill = "#fffaff",
                              colour = "lightblue",
                              size = 0.1, linetype = "solid"),
  ...
  geom_text(aes(label = paste('#', vodid, sep='')))
ggsave("occurrenceTeepHighlight.png")
ggplot(data = all_patterns_df, aes(x = vodid, y = teep50)) + 
  geom_bar(stat = "identity") +
  labs(x = "VOD", 
       y = "Frequency",
       title = paste('Occurrence of teep50Highlight')) + 
  theme(
    panel.background = element_rect(fill = "#fffaff",
                              colour = "lightblue",
                              size = 0.1, linetype = "solid"),
  ...
  geom_text(aes(label = paste('#', vodid, sep='')))
ggsave("occurrenceTeep50Highlight.png")
ggplot(data = all_patterns_df, aes(x = vodid, y = chris)) + 
  geom_bar(stat = "identity") +
  labs(x = "VOD", 
       y = "Frequency",
       title = paste('Occurrence of chris')) + 
  theme(
    panel.background = element_rect(fill = "#fffaff",
                              colour = "lightblue",
                              size = 0.1, linetype = "solid"),
  ...
  geom_text(aes(label = paste('#', vodid, sep='')))
ggsave("occurrenceChrisHighlight.png")
